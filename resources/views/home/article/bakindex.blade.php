            ...
            <div class="row">
                <div class="col-md-9 ml-auto mr-auto">
                    ...
                    <div class="row collections">
                        @foreach($show_article as  $ks => $v)
                            <div class="col-md-12"> 
                                <div class="card" data-background="color" data-color="{{$background_color[$ks]}}" 
                                     data-radius="none">
                                    <div class="card-body text-center">
                                        ...
                                        <a  href="{{url('article_details',['id'=>$v->id])}}" class="btn btn-neutral btn-round">
                                            <i class="fa fa-eye"></i>{{$v->article_click}}
                                        </a> 
                                        <a href="{{url('article_details',['id'=>$v->id])}}"
                                           class="btn btn-neutral btn-round">
                                            <i class="fa fa-newspaper-o"></i>阅读
                                        </a>
