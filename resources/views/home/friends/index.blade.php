            ...
            <div class="row">
                @foreach($recommend_list as $vo)
                  <div class="col-sm-4"> 
                         <div class="card">
                            <div class="card-body">
                              <h4 class="card-title"><i class="nc-icon nc-planet" aria-hidden="true"></i> {{$vo->friends_title}}</h4>
                              <p class="card-text">{{$vo->friends_describe}}  </p>
                              <a href="{{$vo->friends_link}}" class="card-link" target="_blank"> <i class="fas fa-battery-three-quarters"></i></a>
