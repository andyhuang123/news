                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="">
                                ...
                                <p class="text-center"> 
                                     <a href="http://www.seedblog.cn/login/github"> <i class="fa fa-github fa-fw"></i>github登陆</a>
                                </p>
                                <p class="text-center">
                                    <button type="submit" class="btn btn-round btn-primary">登录</button>
                                </p>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">图像</h4>
      </div>
